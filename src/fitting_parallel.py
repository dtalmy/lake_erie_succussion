...
cits = pd.read_csv('../data/chain_inits_parallel_test.csv')
...
pd.DataFrame(d1.get_Rsqrd(d1.integrate(predict_obs=True,as_dataframe=False),print_each=True),index=[0]).to_csv('../data/rsquared_parallel.csv')

pframe = pd.DataFrame(d1.get_parameters(),columns=d1.get_pnames())
pframe.to_csv('../data/chain_inits_parallel_test.csv')
#posteriors.to_csv('../data/posteriors_parallel.csv')

ax1[0].plot(dN.time/365,np.log(dN.abundance))
ax1[1].plot(dP1.time/365,np.log(dP1.abundance))
ax1[2].plot(dP2.time/365,np.log(dP2.abundance))
ax1[3].plot(dZ.time/365,np.log(dZ.abundance))

ax1[0].plot(mdat.time/365,np.log(mdat.P))
ax1[1].plot(mdat.time/365,np.log(mdat.P1))
ax1[2].plot(mdat.time/365,np.log(mdat.P2))
ax1[3].plot(mdat.time/365,np.log(mdat.Z))
...
f1.savefig('../figures/parallel_spinup')
py.show()
py.close(f1)
